...
public class UserController {
    ...
    public UserController(TypeService typeService, ProductService productService, CriteriaService criteriaService, UserService userService, BasketService basketService) {
